...
private let logger = Logger(subsystem: "com.divotgolf.multipeer", category: "MultipeerManager")
...
final class MultipeerManager: NSObject {
  ...
  private let serialQueue = DispatchQueue(label: "com.divotgolf.multipeer.serial")
