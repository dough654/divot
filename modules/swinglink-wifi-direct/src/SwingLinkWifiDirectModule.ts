...
type SwingLinkWifiDirectNativeModule = {
 ...
 */
export const SwingLinkWifiDirectModule =
  requireOptionalNativeModule<SwingLinkWifiDirectNativeModule>('SwingLinkWifiDirect');
